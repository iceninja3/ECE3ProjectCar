...
float kp = -0.01; // proportionality constant
...
int computeError(uint16_t vals[]) { // can consider changing weights
    // right now we are using 8 4 2 1 but could use some other scheme as well
  int sum = 0;
